...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ebooks: Schema.Attribute.Relation<'manyToMany', 'api::ebook.ebook'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDownloadTokenDownloadToken
  ...
  info: {
    description: 'Jednorazowe tokeny do pobierania ebook\u00F3w';
    displayName: 'Token pobrania';
  ...
  attributes: {
    ...
    lastDownloadedAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    maxDownloads: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
...
export interface ApiEbookEbook extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ebooki dost\u0119pne w sklepie';
    displayName: 'Ebook';
    pluralName: 'ebooks';
    singularName: 'ebook';
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Zam\u00F3wienia w sklepie';
  ...
  attributes: {
    ...
    invoiceData: Schema.Attribute.Component<'order.invoice-data', false>;
    invoiceRequested: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ipAddress: Schema.Attribute.String;
